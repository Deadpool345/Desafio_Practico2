...
<h1 class="text-4xl text-center mb-[2rem]">Inscribir Alumno</h1>
...
<form action="inscribir" method="post">
    ...
    <button type="submit" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">Inscribir</button>
</form>
</body>
</html>
